## The plot4.R does the following.
...
##       5. 
##          a. Open graphics device png 
##          b. Change mfrow parameter to 2 rows and 2 columns        
##          c. write the line graphs with Date Time in quadrant 
##          d. before closing the device
## Please refer plot4.png for output
...
##Plot 2
plot(data$DateTime, data$Voltage, type="l", ylab="Global Active Power", xlab="datetime")
...
##Plot 2
plot(data$DateTime, data$Global_reactive_power, type="l", ylab="Global Active Power", xlab="datetime")
